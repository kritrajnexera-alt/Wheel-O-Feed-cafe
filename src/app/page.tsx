          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            {highlights.map((item, i) => (
              <motion.div
                ...
                className="group bg-charcoal border border-amber/10 rounded-2xl p-8 transition-all duration-500 hover:border-amber/30 hover:shadow-[0_0_40px_-8px_rgba(232,160,69,0.25)]"
              >
                <span className="text-4xl mb-5 block group-hover:scale-110 transition-transform duration-500" aria-hidden="true">
                  {item.icon}
                </span>
      ...
      <section className="py-16 sm:py-20 bg-charcoal/50 border-y border-amber/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="font-body text-cream/50 max-w-md mx-auto mb-6">
