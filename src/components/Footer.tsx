      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="flex flex-col items-center text-center gap-6">
          ...
          <a
            ...
            className="inline-flex items-center gap-3 bg-amber text-espresso font-heading font-semibold px-7 py-3.5 rounded-full hover:bg-amber/90 transition-all duration-300 hover:scale-105 active:scale-95"
          >
            <svg
              width="20"
              height="20"
        ...
        <div className="mt-10 pt-8 border-t border-amber/10">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              <Link
                href="/menu"
                className="font-body text-sm text-cream/50 hover:text-amber transition-colors"
              >
                Menu
              </Link>
              <Link
